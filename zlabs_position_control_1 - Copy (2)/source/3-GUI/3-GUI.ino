...
#include <stdio.h>
#include"C:\Users\Ganam\Desktop\zlabs_position_control_1 - Copy (2)\include\encoder.h"
#include"C:\Users\Ganam\Desktop\zlabs_position_control_1 - Copy (2)\include\control.h"
#include"C:\Users\Ganam\Desktop\zlabs_position_control_1 - Copy (2)\include\resetting.h"
...
//         
    ...
    if (state == Running)
    {
        ...
        lcd.print("RU");
        delay(10);
        angle = float(encoderPos+108)/2000*360;
        Input = angle;
        myPID.Compute();
